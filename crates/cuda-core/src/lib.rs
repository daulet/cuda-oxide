...
//! - [`ManagedBuffer`], [`MappedHostBuffer`], [`RegisteredHostMemory`],
//!   [`ReadOnlyRegisteredHostMemory`], and [`ReadOnlyPageableHostMemory`] --
...
pub use blas::{
    Blas, BlasError, BlasMathMode, ProjectionConfig, SgemmConfig, StridedBatchedSgemmConfig,
};
...
pub use residency::{
    ManagedBuffer, MappedHostBuffer, MemoryAdvice, MemoryLocation, ReadOnlyPageableHostMemory,
    ReadOnlyRegisteredHostMemory, RegisteredHostMemory, ResidencyBuffer, ResidencyRequest,
    ResidencyStrategy, StreamAttachment,
};
